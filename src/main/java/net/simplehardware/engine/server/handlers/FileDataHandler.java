...
public class FileDataHandler {
     ...
     */
    public static class MazeFileHandler implements HttpHandler {
        private final DatabaseManager db;

        public MazeFileHandler(DatabaseManager db) {
            this.db = db;
        }
     ...
     */
    public static class GameFileHandler implements HttpHandler {
        private final DatabaseManager db;

        public GameFileHandler(DatabaseManager db) {
            this.db = db;
        }
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            try {
                ...
                net.simplehardware.engine.server.database.models.GameResult gameResult = db.getGameResultById(gameId);
