...
public class UserProfileHandler {
    ...
    /**
         ...
         */
        public record SearchUsersHandler(DatabaseManager db) implements HttpHandler {
    ...
    /**
         ...
         */
        public record GetUserProfileHandler(DatabaseManager db) implements HttpHandler {
