...
public class AdminHandler {
    ...
    public static class AdminDashboardHandler implements HttpHandler {
        private final DatabaseManager db;
        private final SessionManager sessionManager;
        private final AdminMetricsService metricsService;

        public AdminDashboardHandler(DatabaseManager db, SessionManager sessionManager, AdminMetricsService metricsService) {
            this.db = db;
    ...
    public static class MetricsHistoryHandler implements HttpHandler {
        private final DatabaseManager db;
        private final SessionManager sessionManager;

        public MetricsHistoryHandler(DatabaseManager db, SessionManager sessionManager) {
            this.db = db;
            this.sessionManager = sessionManager;
        }
    ...
    public static class DatabaseManagementHandler implements HttpHandler {
        private final DatabaseManager db;
        private final SessionManager sessionManager;

        public DatabaseManagementHandler(DatabaseManager db, SessionManager sessionManager) {
            this.db = db;
            this.sessionManager = sessionManager;
        }
    ...
    public static class SystemStatusHandler implements HttpHandler {
        private final AdminMetricsService metricsService;
        private final SessionManager sessionManager;
        private final DatabaseManager db;

        public SystemStatusHandler(DatabaseManager db, SessionManager sessionManager, AdminMetricsService metricsService) {
            this.db = db;
            this.sessionManager = sessionManager;
            this.metricsService = metricsService;
        }
