...
public class GameHandler {
    ...
    public static class PlayGameHandler implements HttpHandler {
        ...
        public PlayGameHandler(DatabaseManager db, SessionManager sessionManager,
                               GameExecutionService gameService) {
            this.db = db;
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            try {
                ...
                // Send response
                Map<String, Object> response = makeResponse(result, maze);
        ...
        private static Map<String, Object> makeResponse(GameResult result, Maze maze) {
    ...
    /**
         ...
         */
        public record GameResultHandler(DatabaseManager db) implements HttpHandler {
    ...
    /**
         ...
         */
        public record UserHistoryHandler(DatabaseManager db, SessionManager sessionManager) implements HttpHandler {
    ...
    /**
         * List mazes handler
         */
        public record ListMazesHandler(DatabaseManager db, SessionManager sessionManager) implements HttpHandler {
